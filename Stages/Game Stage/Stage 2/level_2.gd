...
var fish_scene = preload("res://Entities/Enemies/Fish/Fish.tscn")
...
func _ready():
	...
	scenes = [frogs1_scene, frogs2_scene, frogs3_scene, fish_scene]
...
func _on_game_timer_timeout():
	...
	if time_left == 30:
		character1.spawn_falling_animation()
		character2.spawn_falling_animation()
...
func stop_game():
	...
	Globalvars.stage_data["stage_2"] = stars_awarded
